...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($name === '' || $username === '' || $password === '') {
        ...
        $passEsc  = mysqli_real_escape_string($conn, $password); // masih plaintext, sesuaikan dengan login

        $sql = "INSERT INTO tb_admin (name, username, password)
                VALUES ('$nameEsc', '$userEsc', '$passEsc')";

        if (mysqli_query($conn, $sql)) {
            $success = "Staf/Admin baru berhasil ditambahkan! Anda akan dialihkan...";
        } else {
...
<head>
    <meta charset="UTF-8">
    <title>Tambah Staf/Admin - Omah Kopi</title>
...
<div class="wrapper-admin">
    ...
    <div class="main-content">
        ...
        <div class="card mb-3">
            <div class="card-header">Form Tambah Staf/Admin</div>
            <div class="card-body">
                <?php if (!empty($success)): ?>
                    <div class="alert alert-success"><?= htmlspecialchars($success); ?></div>
                    <script>
                        setTimeout(function () {
                            window.location.href = "staf_user.php?msg=added";
                        }, 1500);
                    </script>
                <?php endif; ?>
